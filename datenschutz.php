    ...
    <div class="container-xl">
        <div class="row justify-content-center">
            <div class="col-lg-9">
                ...
                <h1 class="heading-lg mb-4">Datenschutzerklärung</h1>
                <p class="text-body">
                    Diese Datenschutzerklärung informiert Sie darüber, wie die Garage Sposato GmbH
                    personenbezogene Daten erhebt, verarbeitet und schützt. Sie gilt für die Website
                    <strong>sposato.ch</strong> und richtet sich nach dem Schweizer Datenschutzgesetz (DSG).
                </p>
