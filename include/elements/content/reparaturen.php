    ...
    <div class="container-xl">
        <div class="row g-5">
            <div class="col-lg-6">
                ...
                <p class="text-body mt-3">Reparaturen aller Art. Motor, Getriebe, Lenkung, Elektronik,
                    Bremsenverschleiss oder ein ungewohntes Geräusch, das sich nur schwer beschreiben lässt – jedes
                ...
                <ul class="brand-list">
                    <li class="brand-item">
                        <img alt="VW" src="assets/images/auto_brands/VW_Logo_farbig.png">
                        <span class="brand-name">VW</span>
                    </li>
                    <li class="brand-item">
                        <img alt="Seat" src="assets/images/auto_brands/SEAT_Logo_farbig.png">
                        <span class="brand-name">Seat</span>
                    </li>
                    <li class="brand-item">
                        <img alt="Audi" src="assets/images/auto_brands/AUDI_Logo_farbig.png">
